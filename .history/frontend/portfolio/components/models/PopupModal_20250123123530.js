  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg p-8 w-full max-w-lg shadow-lg">
        <h2 className="text-2xl font-bold mb-4 text-gray-800">Reach Out to Me</h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1 text-gray-600" htmlFor="subject">
              Subject
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1 text-gray-600" htmlFor="message">
              Message
            </label>
            <textarea
              id="message"
